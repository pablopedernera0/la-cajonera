#!/bin/bash
# =============================================================================
#  setup.sh — crud-stress-test
#  Prepara el entorno para la práctica de stress testing
...
echo ""
echo "=============================================="
echo "  Preparando entorno — crud-stress-test"
echo "=============================================="
...
mkdir -p /root/crud-stress-test

cat > /root/crud-stress-test/docker-compose.yml << 'EOF'
version: '3'
services:
...
cd /root/crud-stress-test
docker-compose up -d
ok "Contenedores iniciados"

# ── 4. Esperar MySQL y crear la base de datos ──────────────────────────────
banner "4/5" "Esperando MySQL y creando la base de datos..."
...
EOSQL
ok "Base 'alumnos' y datos semilla creados"

# ── 5. Clonar el CRUD y levantarlo ──────────────────────────────────────────
banner "5/5" "Clonando la app Flask y conectándola a MySQL..."
