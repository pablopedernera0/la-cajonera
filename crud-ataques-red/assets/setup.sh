#!/bin/bash
# =============================================================================
#  setup.sh — crud-ataques-red
#  Prepara el entorno para la práctica de reconocimiento y fuerza bruta
...
echo ""
echo "=============================================="
echo "  Preparando entorno — crud-ataques-red"
echo "=============================================="
...
DEBIAN_FRONTEND=noninteractive apt-get install -y -qq \
    ...
    nmap \
    hydra
ok "Dependencias del sistema instaladas (incluye nmap y hydra)"
...
mkdir -p /root/crud-ataques-red

cat > /root/crud-ataques-red/docker-compose.yml << 'EOF'
version: '3'
services:
...
banner "5/5" "Clonando la app Flask (con login) y conectándola a MySQL..."
...
echo "    MySQL       → red interna Docker (no publicado al host)"
echo "    PhpMyAdmin  → puerto 8080"
echo "    Nginx       → puerto 80"
echo "    CRUD Flask  → puerto 8888 (con login)"
echo ""
echo "  Próximo paso: reconocimiento con nmap."
echo "=============================================="
echo ""
