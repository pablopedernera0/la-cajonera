#!/bin/bash
# =============================================================================
#  setup.sh — crud-auth-login
#  Prepara el entorno para la práctica de login y control de acceso
...
echo ""
echo "=============================================="
echo "  Preparando entorno — crud-auth-login"
echo "=============================================="
...
mkdir -p /root/crud-auth-login

cat > /root/crud-auth-login/docker-compose.yml << 'EOF'
version: '3'
services:
...
cd /root/crud-auth-login
docker-compose up -d
ok "Contenedores iniciados"

# ── 4. Esperar MySQL y crear las bases de datos ────────────────────────────
...
echo "    CRUD Flask  → puerto 8888 (ahora con login)"
echo ""
echo "  Próximo paso: entender el login que se acaba de agregar."
echo "=============================================="
echo ""
